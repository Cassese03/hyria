...
const Footer = () => {
  return (
    <footer className="site-footer bg-hyria-black text-white">      <div className="container mx-auto px-4 max-w-7xl">
        <div className="footer-top py-8">
          ...
          <div className="social-links flex justify-center gap-4">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="-75 0 600 512" className="w-5 h-5 fill-current">
            ...
            <a 
              ...
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="-120 0 600 512" className="w-5 h-5 fill-current">
            ...
            <a 
              ...
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="-15 0 600 512" className="w-5 h-5 fill-current">
