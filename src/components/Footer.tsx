    ...
    <div className="container mx-auto px-4 max-w-7xl">
      <div className="footer-top py-8">
        ...
        <div className="social-links flex justify-center gap-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-75 0 600 512" className="w-5 h-5 fill-current max-w-full max-h-full">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-120 0 600 512" className="w-6 h-6 md:w-5 md:h-5 fill-current">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-15 0 600 512" className="w-6 h-6 md:w-5 md:h-5 fill-current"></svg>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6 md:w-5 md:h-5 fill-current">
