...
const Sponsor: React.FC = () => {
  ...
  const sponsorshipPackages = [
    {
      name: "Title Sponsor",
      price: "Da 10.000€/anno (esclusa IVA)",
      benefits: [
        "Logo nella sezione sponsor del sito web e social media",
        "Ringraziamenti sui social",
        "Inserimento del logo nel banner multisponsor (Esposto in tutte le partite casalinghe)",
        "Inserimento del logo sull'attrezzatura utilizzata per il settore minibasket",
        "Inserimento del logo sull'attrezzatura utilizzata per la prima squadra e giovanili (CON POSSIBILITA' DI SCELTA POSIZIONE)",
        "Inserimento del logo in un banner pubblicitario singolo (Esposto in tutte le partite casalinghe)",
        "Massima visibilità attraverso l'assoziazione del nome aziendala alla società sportiva (Esempio \"Nome Azienda Hyria Basket\")",
      ],
    },
    {
      name: "Main Sponsor",
      price: "Da €4.000/anno (esclusa IVA)",
      benefits: [
        "Logo nella sezione sponsor del sito web e social media",
        "Ringraziamenti sui social",
        "Inserimento del logo nel banner multisponsor (Esposto in tutte le partite casalinghe)",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Inserimento del logo nel banner multisponsor (Esposto in tutte le partite casalinghe)",
        "Inserimento del logo sull'attrezzatura utilizzata per il settore minibasket",
        "Inserimento del logo sull'attrezzatura utilizzata per la prima squadra e giovanili",
      ],
    },
    {
      name: "Bronze Sponsor",
